      ...
      {debtPlans.length === 0 ? (
        ...
        <>
          ...
          <div className="space-y-4">
            {debtPlans.map((plan) => (
              <div key={plan.id} className={`p-4 rounded-xl border border-pink-200 dark:border-pink-900 bg-white dark:bg-gray-700 shadow-sm hover:shadow-md transition ${!plan.enabled ? 'opacity-50' : ''}`}>
