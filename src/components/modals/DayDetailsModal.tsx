          ...
          <div key={i} className={`flex justify-between items-center p-3 rounded-lg border ${txColor(t)}`}>
            ...
            <div className="flex items-center space-x-2 flex-shrink-0 ml-2">
              ...
              {t.type === 'One-Time' && t.id && (
                <>
                  <button onClick={() => onEditOneTime(t.id!)} className="text-gray-400 hover:text-purple-600 p-1 transition-colors" aria-label="Edit">
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/>
                      <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>
                    </svg>
                  </button>
                  <button onClick={() => onDeleteOneTime(t.id!)} className="text-gray-400 hover:text-red-600 p-1 transition-colors" aria-label="Delete">
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
