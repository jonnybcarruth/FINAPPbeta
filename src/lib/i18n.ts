...
export const translations: Record<Lang, Record<string, string>> = {
  ...
  pt: {
    ...
    smart_budget: 'Orçamento Inteligente',
    this_weeks_budget: 'Orçamento da Semana',
    you_can_spend: 'Você pode gastar',
    how_calculated: 'Como calculamos',
    balance_today: 'Saldo hoje',
    income_this_week: 'Renda esta semana',
    bills_this_week: 'Contas esta semana',
    savings_auto: 'Contribuições de poupança',
    debt_this_week: 'Pagamentos de dívida',
    reserve_for: 'Reserva para',
    emergency_buffer: 'Reserva de emergência',
    safe_to_spend: 'Seguro para gastar',
    per_week_budget: 'por semana',
    suggested_split: 'Divisão sugerida',
    show_details: 'Ver detalhes',
    hide_details: 'Ocultar detalhes',
    no_budget_data: 'Adicione renda e contas para ver seu orçamento semanal',
  },
};
